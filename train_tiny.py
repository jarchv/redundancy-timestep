...
# state 1: DiT Default
# state 2: DiT - timestep embedder (WITHOUT TIME EMBEDDER)
# state 3: U-Net Default
# state 4: U-Net - timestep embedder (WITHOUT TIME EMBEDDER)
...
def main(args):
    ...
    # Data loading
    train_loader, train_size = utils.get_tiny_train(args)
...
#   Dataset
    ...
    parser.add_argument('--in_resolution', type=int, default=64, help='image size')                      
...
#   Experiments
    parser.add_argument('--ckpt_every', type=int, default=5, help='save after every "ckpt_every" epoch')
    ...
    parser.add_argument('--log_every', type=int, default=1000, help='log after every "log_every" steps')
...
#   Hyperparameters
    ...
    parser.add_argument('--batch_size', type=int, default=64 , help='batch size')        # 64,NW=2, -> DiT_S,           
    parser.add_argument('--epochs', type=int, default=1000, help='number of epochs')
    parser.add_argument('--model_lr', type=float, default=1e-5, help='learning rate in rec_loss.') 
